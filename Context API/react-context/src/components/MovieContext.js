...
export const MovieProvider = (props) => {
    ...
    const [state , setState] = useState( //MovieProvider component provides the information to the components
       [
    ...
    return(
        <MovieContext.Provider value={[state,setState]}>{/* Now anything wrapped in these will have access to the state above*/}
            {props.children}
